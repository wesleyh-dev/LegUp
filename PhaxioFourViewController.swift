...
class PhaxioFourViewController: UIViewController {
    ...
    // body inputs
    @IBOutlet weak var introInput: UITextView!
    @IBOutlet weak var affectInput: UITextView!
    @IBOutlet weak var goodInput: UITextView!
    @IBOutlet weak var futureInput: UITextView!
    ...
    @IBAction func reviewFaxButtonAction(_ sender: Any) {
        ...
        self.performSegue(withIdentifier: "toWBVFour", sender: file)
    }
    ...
    func generateHTMLString() -> String{
        ...
        let intro = self.introInput.text!.replacingOccurrences(of: "\n", with: "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;")
        let affect = self.affectInput.text!.replacingOccurrences(of: "\n", with: "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;")
        let good = self.goodInput.text!.replacingOccurrences(of: "\n", with: "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;")
        let future = self.futureInput.text!.replacingOccurrences(of: "\n", with: "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;")
        ...
        let head = ""
        let body = "<p>\(header_h)<br><p style=\"font-weight: bold; text-align: center;\">RE: \(billName_h)</p>\(dearLabel_h)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\(intro)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\(affect)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\(good)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\(future)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\(closing)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\(thanks)</p><p style=\"margin-left:65%;\">\(sig_h)<br>\(addrln1_h)<br>\(addrln2_h)<br>Phone: \(phoneNum_h)<br>Fax: \(faxNum_h)</span></p>"
