//
//  PhaxioTableViewController.swift
//  MySampleApp
//
...
class PhaxioTableViewController: UITableViewController {
    
    let templateArray = ["Personal credentials","Personal interest with counter arguements and proposed solution","Personal Story with bulleted data","Hypothetical scenario or bill","Thank you letter","Create your own"]
